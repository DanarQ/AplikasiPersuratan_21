...
<body style="background: white">
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-md-12">
                <div>
                    <h3 class="text-center my-4">Data Hasil Pengiriman Surat</h3>
                    <hr>
                </div>
                <div class="card border-0 shadow-sm rounded">
                    <div class="card-body">
                        <a href="{{ route('pengguna.create') }}" class="btn btn-md btn-info mb-3">TAMBAH SURAT</a>
