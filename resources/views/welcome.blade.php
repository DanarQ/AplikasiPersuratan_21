...
<body class="host_version">
	...
	<div class="all-title-box">
		<div class="container text-center">
			<h1>Persuratan center Sintang<span class="m_1">Kami melayani Anda dengan sepenuh hati.</span></h1>
		</div>
	</div>
		...
		<div class="container">
			<div class="section-title row text-center">
				<div class="col-md-8 offset-md-2">
					<p class="lead">"Percayakan Surat anda pada layanan profesional kami di Sintang. Aman dan terpercaya untuk semua masalah persuratan "</p>
				</div>
			</div><!-- end title -->
